@extends('layouts.app')
@section('title', ' منظومة الشحن الجديدة')
@section('style')
...
@section('content')
    ...
    <div class="list">
        <ul>
            ...
            @endcanView
            @canView('stats')
            <li><a href="/RStats/{{ $vessel->vessel_id }}"><i class="fas fa-chart-line"></i> معدلات عملية الشحن </a></li>
            @endcanView
            @canView('analysis')
        ...
        <ul>
            ...
            @canView('arrival')
            <li><a href="/RArrival/{{ $vessel->vessel_id }}"><i class="fas fa-truck-loading"></i> تقرير الشحن على الرصيف
                </a>
            </li>
            @endcanView
            @canView('quantity')
            ...
            @endcanView
            @canView('loading')
            <li><a href="/RLoading/{{ $vessel->vessel_id }}"><i class="fas fa-warehouse"></i> تقرير التحميل من المخازن
                </a>            
            </li>
    @endcanView
            @canView('stops')
